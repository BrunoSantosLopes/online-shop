                ...
                <form class="form" action="${pageContext.request.contextPath}/payment"  method="post">
                    <div class="caddie">
                        <table class="table">
                            ...
                            %>
                            <tr class="row">
                                <td><div class="cell"><%=rowProductsCaddy.getKey().getName()%></div></td>
                                <td><div class="cell"><%=rowProductsCaddy.getValue()%></div></td>
                                <td><div class="cell">CHF <%=String.format("%.2f",price)%></div></td>
                            </tr>
                    ...
                    <div class="container-input">
                        <div class="field">
                            <label>Nom : </label>
                            <div class="input">
                                <input name="name"  type="text"  placeholder="Nom" required autofocus autocomplete="off" value="${name}">
                        ...
                        <div class="field">
                            <label>Email :</label>
                            <div class="input">
                                <input name="email" type="email" placeholder="Email" required autocomplete="off" value="${email}" >
                        ...
                        <div class="field">
                            ...
                            <div class="input">
                                <input name="numberCard" type="text" placeholder="Carte de crédit" minlength="16" maxlength="16" required autocomplete="off" value="${numberCard}">
                        ...
                        <div class="field">
                            ...
                            <div class="field-month-year">
                                <div class="input">
                                    <input name="month" type="number" placeholder="Month" min="1" max="12"  required autocomplete="off" value="${month}">
                                    <p class="red">${monthMessage}</p>
                                </div>
                                <div class="input">
                                    <input name="year" type="number" placeholder="Year" min="19"  max="99" required autocomplete="off" value="${year}">
